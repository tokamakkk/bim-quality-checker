...
> **HKU AI Agent Technical Test** 参赛作品：一个基于 Web 的微型原型，对建筑 IFC 模型执行**合规性检查**，并内置 **AI 质量助手**，可解释检查结果、在确认后引导修复模型属性。
>
...
- **无需复杂几何计算**：两条规则均基于属性读取，1–2 条规则做精、做透，符合题目"不要追求完美"的评估导向
...
以下为诚实的简化说明（完整版见 [doc/DESIGN.md](doc/DESIGN.md) §4.4 / §7）：
